...
export const uiTranslations = {
    ...
    en: {
        ...
        countyBorders: 'County Borders',
        townshipContours: 'Township Outlines',
        villageBorders: 'Village Borders (Zoom in)',
        areaNames: 'Label Display',
        level1Names: 'County Names',
        level2Names: 'Township Names',
        level3Names: 'Village Names (Zoom in)',
        boundaryDisplay: 'Boundaries & Coloring',
        villageColors: 'Village Detail Colors (Mode B)',
        sharedDialects: 'Shared Dialects (Split Color)',
        showFixedInfo: 'Pinned Sidebar (Desktop)',
